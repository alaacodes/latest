...
import birdhouseImg from '../../assets/images/birdhouseai.png';
import systemgrownImg from '../../assets/images/systemgrown.png';
      ...
      <div className="info-blocks">
        <div className="info-block">
          ...
          <div className="info-image" data-caption="The Birdhouse AI: The Future of AI Content">
            <img src={birdhouseImg} alt="Birdhouse Preview" />
          </div>
        </div>
        <div className="info-block">
          ...
          <div className="info-image" data-caption="SystemGrown: Turning Creative Workflows into Art">
            <img src={systemgrownImg} alt="Scheduling Preview" />
          </div>
        </div>
      </div>
    </div>
